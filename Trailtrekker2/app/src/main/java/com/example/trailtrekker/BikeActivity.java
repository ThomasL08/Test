...
public class BikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hike); // Assuming the layout file for BikeActivity is the same as HikeActivity
        ...
        if (intent != null && intent.hasExtra("activityType")) {
            ...
            // Default to "Bike" if activity type is not provided
            activityType = "Bike";
        }
