...
//        setContentView(R.layout.activity_hike); // Assuming the layout file for WalkActivity is the same as HikeActivity
//
...
//        } else {
//            // Default to "Walk" if activity type is not provided
//            activityType = "Walk";
//        }
//
