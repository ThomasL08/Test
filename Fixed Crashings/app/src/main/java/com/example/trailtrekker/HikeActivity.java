        ...
        if (!answer.isEmpty()) {
            switch (index) {
                ...
                case 2:
                    ...
                    db.updateRow(1, caloriesContent);
                    break;
                case 3:
                    ...
                    db.updateRow(1, distanceContent);
                    break;
                case 4:
                    ...
                    db.updateRow(1, stepCountContent);
                    break;
                case 5:
                    Toast.makeText(this, "weight saved: " + answer, Toast.LENGTH_SHORT).show();
                    ContentValues weightContent = new ContentValues();
                    weightContent.put(Constants.WEIGHT, answer);
                    db.updateRow(1, weightContent);
                    break;
                case 6:
                    Toast.makeText(this, "height saved: " + answer, Toast.LENGTH_SHORT).show();
                    ContentValues heightContent = new ContentValues();
                    heightContent.put(Constants.HEIGHT, answer);
                    db.updateRow(1, heightContent);
                    break;
            }
        } else {
