...
public class HikeExerciseActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener, SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int caloriesGoal = myDatabase.getCaloriesGoal();
        int distanceGoal = myDatabase.getDistanceGoal();
        int stepCountGoal = myDatabase.getStepCountGoal();

        // Display goals in the appropriate TextViews
        gCalTV.setText(String.valueOf(caloriesGoal));
        gDisTV.setText(String.valueOf(distanceGoal));
        gStepTV.setText(String.valueOf(stepCountGoal));
        //STOPWATCH/////////////////////////////////////////
